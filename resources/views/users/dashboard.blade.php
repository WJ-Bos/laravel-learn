        ...
        <div class="flex flex-col md:flex-row gap-6 mb-8">
            ...
            <div class="flex-1">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <button
                        class="mt-4 md:mt-0 bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-full transition duration-200 shadow-sm">
                        Edit Profile
                    </button>
                </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold mt-1">{{ count($posts) }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('posts.mine') }}" class="text-blue-600 text-sm hover:underline">View All</a>
                </div>
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                                <div class="flex items-start">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div>
                                            <h3 class="text-xl font-bold pb-2 pt-2 underline">{{ $post->title }}</h3>
                                        </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="text-sm text-gray-800"><span class="font-medium">Sarah Miller</span> liked
                                    your post</p>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="text-sm text-gray-800"><span class="font-medium">Mike Chen</span> commented:
                                    "Great shot!"</p>
